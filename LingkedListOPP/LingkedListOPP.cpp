...
void List::addNode() //menambah sebuah node kedalam list
{
	...
	//jika loop di eksekusi, provious dan current akan menempati posisi dimana dimana
...
bool List::delNode(int nim) //menghapus node ke dalam list 
{
